...
export type MeetupsWithCommentsAndUserSubscriptionVariables = {};


export type MeetupsWithCommentsAndUserSubscription = (
  { __typename?: 'subscription_root' }
  & { meetup: Array<(
    { __typename?: 'meetup' }
    & Pick<Meetup, 'id' | 'name' | 'datetime' | 'description' | 'location' | 'image_url'>
    & { comments: Array<(
      { __typename?: 'meetup_comment' }
      & Pick<Meetup_Comment, 'id' | 'text'>
      & { user: (
        { __typename?: 'user' }
        & Pick<User, 'username'>
      ) }
...
export type SignupMutation = (
  ...
  & { Signup?: Maybe<(
    { __typename?: 'SignupResponse' }
    & Pick<SignupResponse, 'username' | 'password'>
  )> }
);
...
export type LoginQuery = (
  ...
  & { Login?: Maybe<(
    { __typename?: 'JsonWebToken' }
    & Pick<JsonWebToken, 'token'>
  )> }
);

export type AddCommentMutationVariables = {
  meetupId: Scalars['Int'];
  text: Scalars['String'];
};
...
export type AddCommentMutation = (
  { __typename?: 'mutation_root' }
  & { insert_meetup_comment_one?: Maybe<(
    { __typename?: 'meetup_comment' }
    & Pick<Meetup_Comment, 'id' | 'text'>
  )> }
);

export type DeleteCommentByIdMutationVariables = {
  id: Scalars['Int'];
};
...
export type DeleteCommentByIdMutation = (
  { __typename?: 'mutation_root' }
  & { delete_meetup_comment_by_pk?: Maybe<(
    { __typename?: 'meetup_comment' }
    & Pick<Meetup_Comment, 'id'>
  )> }
);


export const MeetupsWithCommentsAndUserDocument = gql`
...
/**
 * __useMeetupsWithCommentsAndUserSubscription__
 *
 * To run a query within a Vue component, call `useMeetupsWithCommentsAndUserSubscription` and pass it any options that fit your needs.
 * When your component renders, `useMeetupsWithCommentsAndUserSubscription` returns an object from Apollo Client that contains result, loading and error properties
 ...
 *
 * @example
 * const { result, loading, error } = useMeetupsWithCommentsAndUserSubscription(
 *   {
 *   }
 * );
 */
export function useMeetupsWithCommentsAndUserSubscription(options: VueApolloComposable.UseSubscriptionOptions<MeetupsWithCommentsAndUserSubscription, MeetupsWithCommentsAndUserSubscriptionVariables> | VueCompositionApi.Ref<VueApolloComposable.UseSubscriptionOptions<MeetupsWithCommentsAndUserSubscription, MeetupsWithCommentsAndUserSubscriptionVariables>> | ReactiveFunction<VueApolloComposable.UseSubscriptionOptions<MeetupsWithCommentsAndUserSubscription, MeetupsWithCommentsAndUserSubscriptionVariables>> = {}) {
          return VueApolloComposable.useSubscription<MeetupsWithCommentsAndUserSubscription, undefined>(MeetupsWithCommentsAndUserDocument, undefined, options);
        }
export type MeetupsWithCommentsAndUserSubscriptionCompositionFunctionResult = VueApolloComposable.UseSubscriptionReturn<MeetupsWithCommentsAndUserSubscription, MeetupsWithCommentsAndUserSubscriptionVariables>;
 ...
 * });
 */
export function useSignupMutation(options: VueApolloComposable.UseMutationOptionsWithVariables<SignupMutation, SignupMutationVariables>) {
 ...
 *   variables: {
 *      meetupId: // value for 'meetupId'
 *      text: // value for 'text'
 *   },
 * });
 */
export function useAddCommentMutation(options: VueApolloComposable.UseMutationOptionsWithVariables<AddCommentMutation, AddCommentMutationVariables>) {
 ...
 *
 * To run a mutation, you first call `useDeleteCommentByIdMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useDeleteCommentByIdMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useDeleteCommentByIdMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useDeleteCommentByIdMutation(options: VueApolloComposable.UseMutationOptionsWithVariables<DeleteCommentByIdMutation, DeleteCommentByIdMutationVariables>) {
            return VueApolloComposable.useMutation<DeleteCommentByIdMutation, DeleteCommentByIdMutationVariables>(DeleteCommentByIdDocument, options);
          }
export type DeleteCommentByIdMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<DeleteCommentByIdMutation, DeleteCommentByIdMutationVariables>;