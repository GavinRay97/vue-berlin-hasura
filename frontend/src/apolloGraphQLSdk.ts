...
export type AllUserQuery = { __typename?: 'query_root' } & {
  user: Array<{ __typename?: 'user' } & Pick<User, 'id' | 'username'>>
}
...
export function useAllUserQuery(
  options:
    | VueApolloComposable.UseQueryOptions<AllUserQuery, AllUserQueryVariables>
  ...
  return VueApolloComposable.useQuery<AllUserQuery, undefined>(
    AllUserDocument,
    undefined,
    options
  )
}
export type AllUserQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<
  AllUserQuery,
